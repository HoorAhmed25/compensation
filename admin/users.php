    ...
    <div class="row">
      ...
      <div class="dropdown show d-inline h3">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
          ...
          <a class="dropdown-item border-bottom text-center" href="search.php">تسجيل جديد</a>
          <a class="dropdown-item border-bottom text-center" href="inquery.php">استعلام </a>
          <a class="dropdown-item border-bottom text-center" href="report.php"> متابعة تقارير</a>
          <a class="dropdown-item border-bottom text-center" href="activity.php">سجل الخدمات </a>
            <a class="dropdown-item border-bottom text-center" href="provider.php">سجل الجهات المعاونة </a>
