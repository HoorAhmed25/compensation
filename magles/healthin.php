...
if(isset($_POST['confirm'])){
  ...
  <div class="form-check col-3">
            ...
            <div id="deathdate" class="mb-3 col-2">
              <label id="dateofdeathlbl" for="dateofdeath" class="form-label">تاريخ الإصابة :</label>
 ...
 <div class = "row">
  ...
  <div class="row mr-3">
            ...
            <div class="mb-3 col-3">
             <label class="mt-1" for="reportin">تقرير الأصابة :</label>
				<input type="file" id="reportin" name="reportin" required>
            </div>
            ...
            <div id="date" class="mb-3  col-3">
              <label for="datej" class="form-label">تاريخ الأصابة :</label>
              <input type="date" class="form-control" name="datej"   autocomplete="off" required>
            </div>

                
                    <div id="perc" class="mb-3 col-3">
              <label for="perc" class="form-label">نسبة العجز :</label>
              <select name="perc" id="perc" class="form-select   form-control" required>
                <option>--اختر--</option>
                <option value="0-20">0-20</option>
                <option value="21-40">21-40</option>
                <option value="21-60">41-60</option>
    ...
    if(isset($_POST['submit'])){
        ...
        $perc = $_POST['perc'];
        $datej = $_POST['datej'];
        $fileattcert = $_FILES['reportin'];
$fileNameattcert = $_FILES['reportin']['name'];
$fileTemNameattcert = $_FILES['reportin']['tmp_name'];
$fileSizeattcert = $_FILES['reportin']['size'];
$fileErrorattcert = $_FILES['reportin']['error'];
$fileTypeattcert = $_FILES['reportin']['type'];
...
$ins = "UPDATE deathinfo SET reportin = '$fileDestinationattcert', datej = '$datej', perc = '$perc', status = 'صندوق' WHERE nationalID = '$ID';";
